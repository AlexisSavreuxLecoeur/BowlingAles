...
<html lang="fr">
    <head>
        <title>Bowling d'Alès | Site Officiel</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Page Accueil Le Bowling d'Alès" />
        <!-- Style Normal -->
        ...
        <link href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/Style_Files/5_css_accueil.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/5_css_accueil.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
        -->
    </head>
    <body>
        <?php
            /* header.php contient les liens des fichiers pour le haut de page */
            /* navbar.php contient les liens des fichiers pour le menu de navigation */
            /* acceuil.php contient les liens des fichiers pour la page d'accueil */
            /* footer.php contient les liens des fichiers pour le bas de page */
            include('header.php');
            include('navbar.php');
            include('accueil.php');
            include('footer.php');
