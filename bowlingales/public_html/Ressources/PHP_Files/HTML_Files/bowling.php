...
<html lang="fr">
    <head>
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files/6_css_bowling.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/6_css_bowling.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
        -->
    </head>
    <body>
