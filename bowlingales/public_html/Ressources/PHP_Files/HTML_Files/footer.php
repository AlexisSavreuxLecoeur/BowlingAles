<footer id="F_">
    <div id="F_Box_Footer">
        <div id="F_Colonne_1">
            <div id="F_T1">
            <p id="F_Texte_1">Nous contacter :</p>
            </div>
            <div id="F_Tel">
            <p id="F_Telephone"> +33 (0) 4 66 52 00 81</p>
            </div>
            <div id="F_Mail">
            <p id="F_Adresse_E-Mail">bowlingales@gmail.com</p>
            </div>
            <div id="F_T2">
    ...
    <div id="F_Box_Copyright">
        <p>&copy; 2020 Alexis Savreux--Lecoeur</p>
    </div>
</footer>