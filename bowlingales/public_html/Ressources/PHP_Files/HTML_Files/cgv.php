<html>
    <head>
        <title>Bowling d'Alès | CGV</title>
        <meta charset="UTF-8">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files/15_css_cgv.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/15_css_cgv.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
        -->
    </head>
    <body>
        ...
        <main id="Contenu">
            <p>Bonjour,<br>
            Votre page "Conditions Générales de Vente" est en cours de construction.<br>
