<html>
    <head>
        ...
        <link href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/Style_Files/15_css_cgv.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/15_css_cgv.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
    </head>
    <body>
        <?php
