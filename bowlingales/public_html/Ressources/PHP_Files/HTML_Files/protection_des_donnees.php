<html>
    <head>
        <title>Bowling d'Alès | Protection Des Données</title>
        <meta charset="UTF-8">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files/13_css_protection_des_donnees.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/13_css_protection_des_donnees.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
        -->
    </head>
    <body>
        ...
        <main id="Contenu">
            <p>Bonjour,<br>
            Votre page "Protections des Données Personnelles" est en cours de construction.<br>
            Merci de votre compréhension
            </p>
            <a href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/HTML_Files/">
                <input type="button" value="Retour à l'acceuil du site internet">
            </a>
        </main>
        <?php
            include('footer.php');
