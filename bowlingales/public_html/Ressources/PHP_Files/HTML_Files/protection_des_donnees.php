<html>
    <head>
        ...
        <link href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/Style_Files/13_css_protection_des_donnees.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/13_css_protection_des_donnees.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
    </head>
    <body>
        <?php
        ...
        <main id="Contenu">
            ...
            <a href="http://localhost/bowlingales/public_html/Ressources/PHP_Files/HTML_Files/">
