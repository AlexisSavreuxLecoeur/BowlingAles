<html>
    <head>
        <title>Bowling d'Alès | Cookies</title>
        <meta charset="UTF-8">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files/14_css_cookies.php" rel="stylesheet" type="text/css">
        ...
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/PHP_Files/Style_Files_Halloween/14_css_cookies.php" rel="stylesheet" type="text/css">
        <link href="http://localhost/bowlingales/bowlingales/public_html/Ressources/1_Title/favicon.ico" rel="icon">
        -->
    </head>
    <body>
        ...
        <main id="Contenu">
            <p>Bonjour,<br>
            Votre page "Cookies" est en cours de construction.<br>
